...
class CreateZFFLDGMTBRTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Z_FF_LDG_MTBR', function (Blueprint $table) {
            $table->increments('ID_Z_FF_LDG_MTBR');
    ...
    {
        Schema::dropIfExists('Z_FF_LDG_MTBR');
    }
}
