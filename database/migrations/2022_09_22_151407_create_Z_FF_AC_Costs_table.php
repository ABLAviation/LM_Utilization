...
class CreateZFFACCostsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Z_FF_AC_Costs', function (Blueprint $table) {
            $table->increments('ID_Z_FF_AC_Costs');
    ...
    {
        Schema::dropIfExists('Z_FF_AC_Costs');
    }
}
