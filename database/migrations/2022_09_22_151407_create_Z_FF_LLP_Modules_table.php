...
class CreateZFFLLPModulesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Z_FF_LLP_Modules', function (Blueprint $table) {
            $table->increments('ID_Z_FF_LLP_Modules');
    ...
    {
        Schema::dropIfExists('Z_FF_LLP_Modules');
    }
}
