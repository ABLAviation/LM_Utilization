...
class CreateSpecSheetAPULLPTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('SpecSheet_APU_LLP', function (Blueprint $table) {
            $table->increments('ID_SpecSheet_APU_LLP');
            $table->integer('MSN');
    ...
    {
        Schema::dropIfExists('SpecSheet_APU_LLP');
    }
}
