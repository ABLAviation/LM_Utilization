...
class CreateZNewFFEPRCostsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Z_NewFF_EPR_Costs', function (Blueprint $table) {
            $table->increments('ID_Z_NewFF_EPR_Costs');
    ...
    {
        Schema::dropIfExists('Z_NewFF_EPR_Costs');
    }
}
