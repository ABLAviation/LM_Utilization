...
class CreateZFFACMTBRTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('Z_FF_AC_MTBR', function (Blueprint $table) {
            $table->increments('ID_Z_FF_AC_MTBR');
            ...
            $table->string('Output_var5', 3000)->nullable();
        });
    }
    ...
    {
        Schema::dropIfExists('Z_FF_AC_MTBR');
    }
}
